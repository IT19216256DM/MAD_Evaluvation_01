...
public class FoodRetrievePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_retrieve_page);

        butsave = (Button) findViewById(R.id.buttonsavedetails);
        butsave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(FoodRetrievePage.this,FoodHomePage.class);
        ...
        buteditdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext(), EditFoodPage.class);
                clearControls();
